...
@mcp.tool()
async def graphql(query: str, variables: Optional[str] = None) -> str:
    """
...
async def get_tenants() -> str:
    ...
    """
    return await graphql(GET_TENANTS_QUERY)
...
async def get_types() -> str:
    ...
    """
    return await graphql(GET_TYPES_QUERY)
...
async def get_details_types() -> str:
    ...
    """
    return await graphql(GET_TYPE_DETAILS_QUERY)
